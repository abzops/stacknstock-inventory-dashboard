...
function openPrintDocument(title, subtitle, content) {
  ...
  const logos = Array.from(w.document.querySelectorAll("[data-print-logo], [data-print-watermark]")).filter((img) => !img.complete);
  if (logos.length) {
    let printed = false;
